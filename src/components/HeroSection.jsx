...
const HeroSection = (props) => {
  ...
  return (
    <div className="relative h-[96%] w-[95%] pt-10 pb-10 rounded-3xl overflow-hidden bg-black border border-zinc-800">
    ...
    <div className="h-14 md:h-24">
      <h2 className="text-2xl md:text-5xl lg:text-6xl font-[port2] font-bold text-gray-400">
        ...
        <span className="inline-block w-[2px] md:w-[3px] h-7 md:h-14 bg-white ml-1 animate-blink"></span>
          ...
          {/* CTA Buttons - STABLE */}
          <div className="flex flex-wrap gap-3 md:gap-4 justify-center mt-6 md:mt-8 opacity-0 animate-fadeInUp animation-delay-600">
            <a
              href="#projects"
          ...
          {/* Social Links - STABLE */}
          <div className="flex gap-4 md:gap-5 justify-center mt-6 md:mt-4 mb-8 opacity-0 animate-fadeInUp animation-delay-800">
            {[
